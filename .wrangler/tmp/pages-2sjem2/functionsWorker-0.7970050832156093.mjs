...
var import_standardwebhooks, onRequest;
var init_dodo = __esm({
  "api/webhooks/dodo.ts"() {
    init_functionsRoutes_0_39528541517797966();
    init_strip_cf_connecting_ip_header();
    ...
    init_db();
    onRequest = /* @__PURE__ */ __name(async ({ request, env }) => {
...
var init_checkout_session = __esm({
  "api/checkout-session.ts"() {
    ...
    init_db();
    init_session();
    onRequest2 = /* @__PURE__ */ __name(async ({ request, env }) => {
      if (request.method !== "POST") {
...
var ITERATIONS, KEY_LENGTH_BITS;
...
var init_login = __esm({
  "api/login.ts"() {
    ...
    init_db();
    init_session();
    onRequest3 = /* @__PURE__ */ __name(async ({ request, env }) => {
      if (request.method !== "POST") {
        return new Response(JSON.stringify({ error: "Method not allowed" }), { status: 405, headers: { "Content-Type": "application/json" } });
      }
      let body;
...
var init_logout = __esm({
  "api/logout.ts"() {
    ...
    init_strip_cf_connecting_ip_header();
    init_session();
    onRequest4 = /* @__PURE__ */ __name(async ({ request, env }) => {
      if (request.method !== "POST") {
        return new Response(JSON.stringify({ error: "Method not allowed" }), { status: 405, headers: { "Content-Type": "application/json" } });
      }
...
var init_me = __esm({
  "api/me.ts"() {
    ...
    init_session();
    init_db();
    onRequest5 = /* @__PURE__ */ __name(async ({ request, env }) => {
...
var init_track = __esm({
  "track.ts"() {
    init_functionsRoutes_0_39528541517797966();
    init_strip_cf_connecting_ip_header();
    onRequest8 = /* @__PURE__ */ __name(async ({ request }) => {
...
// ../.wrangler/tmp/bundle-L31jVR/middleware-loader.entry.ts
init_functionsRoutes_0_39528541517797966();
init_strip_cf_connecting_ip_header();

// ../.wrangler/tmp/bundle-L31jVR/middleware-insertion-facade.js
init_functionsRoutes_0_39528541517797966();
init_strip_cf_connecting_ip_header();
...
//# sourceMappingURL=functionsWorker-0.7970050832156093.mjs.map
